...
if ($Checks) {
    ...
    Invoke-GodotReview 'skill-expansion' '--headless res://tests/skill_expansion.tscn'
    Invoke-GodotReview 'skill-expansion-review' '--position -9999,-9999 res://experiments/skill_expansion_review.tscn'
} elseif ($CombatFeel) {
    Invoke-GodotReview 'combat-feel-import' '--headless --import'
    Invoke-GodotReview 'combat-presentation' '--headless res://tests/combat_presentation.tscn'
    Invoke-GodotReview 'combat-feel-review' '--position -9999,-9999 res://experiments/combat_feel_review.tscn'
} elseif ($Combat) {
    ...
    Invoke-GodotReview 'build-usability' '--headless res://tests/build_usability.tscn'
    Invoke-GodotReview 'build-picker-review' '--position -9999,-9999 res://experiments/build_picker_review.tscn'
} elseif ($Gathering) {
