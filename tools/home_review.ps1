param(
    ...
    [ValidateSet('home','home-reliability','interaction-feedback','footsteps-ambience','forge-readability','workshop-usability','placement-reliability','building-loads','quiet-ambience','foundry-clarity','forge-pressure','forge-progression','frontier-population')][string]$ReviewSet = 'home',
...
try {
    ...
    foreach ($homeScene in $Scenes) {
        ...
        if ($ReviewSet -in @('interaction-feedback','footsteps-ambience','forge-readability','workshop-usability','building-loads','quiet-ambience','foundry-clarity','forge-pressure','forge-progression','frontier-population')) { $homeFlags += ' --audio-driver Dummy' }
