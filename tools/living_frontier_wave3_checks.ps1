param([switch]$Hosts, [switch]$Native, [switch]$Full, [switch]$Import, [switch]$Visuals)
...
if ($lf3Options.Native) {
    ...
    foreach ($lfTest in @('test_living_frontier_wave3','test_main','test_leyline','test_living_frontier_wave2')) {
