...
media=out/'media'
evidence=root/'docs/prototype/rf05-evidence-2026-09-15'
evidence.mkdir(parents=True,exist_ok=True)
for name in ['01-lakeside-home.png','02-surface-swimming.png','03-shore-outlook.png']:
...
frames[0].save(evidence/'swim.gif',save_all=True,append_images=frames[1:],duration=[60,70,70]*40,loop=0,optimize=False)
with Image.open(evidence/'swim.gif') as clip:
    duration=0
