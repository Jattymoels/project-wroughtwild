...
foreach ($name in @('project.godot','review.tscn','review.gd','fauna_scar.gdshader','wolf.json')) {
...
foreach ($name in @('normal.png','wolf-near.glb','wolf-mid.glb','wolf-far.glb','rig-report.json')) {
