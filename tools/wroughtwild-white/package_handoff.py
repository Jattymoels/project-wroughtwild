"""Pack one checked White review. Usage: REVIEW EDITABLE ASSETS SOURCE FRESH_OUT.
...
docs=repo/'docs/art/leyline-studies/2026-09-09/workshop-white'
shutil.copy2(docs/'white-inclusion-input-v01.png',out/'provenance/white-inclusion-input-v01.png')
...
print('WHITE_PACKAGE_VERIFIED',len(manifest),'files',sum(v['bytes'] for v in manifest.values()),'bytes')
