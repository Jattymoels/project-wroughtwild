param([Parameter(Mandatory)][string]$Revision, [Parameter(Mandatory)][string]$Output)
$ErrorActionPreference='Stop'
$artRepo='C:/Users/Matty/Dev/project-wroughtwild'
...
$artCompiler=Join-Path 'C:/Users/Matty/AppData/Local' 'Microsoft/WinGet/Packages/BrechtSanders.WinLibs.POSIX.UCRT_Microsoft.Winget.Source_8wekyb3d8bbwe/mingw64/bin/g++.exe'
...
project(art07b2_native LANGUAGES CXX)
...
Write-Output 'B2_NATIVE_BUILD_OK'
