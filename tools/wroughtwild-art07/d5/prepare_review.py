...
shutil.copy2(blender/'d5_proxies.glb',out/'d5_proxies.glb')

shutil.copy2(blender/'blender-audit.json',out/'blender-audit.json')

(out/'review.tscn').write_text('[gd_scene load_steps=2 format=3]\n\n[ext_resource type="Script" path="res://review.gd" id="1"]\n\n[node name="D5Review" type="Node3D"]\nscript = ExtResource("1")\n')

print('D5_REVIEW_PREPARED',out)
