...
if (-not $artOutput.StartsWith((Join-Path $d3Worker 'build/art07/d3')+[IO.Path]::DirectorySeparatorChar)) { throw 'Output must remain in the D3 build tree.' }
...
project(art07_d3_native LANGUAGES CXX)
...
Write-Output 'D3_NATIVE_BUILD_OK'
