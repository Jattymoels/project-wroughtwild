...
master=source/'core-lattice.blend'; before=hashlib.sha256(master.read_bytes()).hexdigest()
...
assert len(assets)==len(runtime.objects)==10 and set(assets)==set(geometry['assets'])
...
print('D1_REOPEN_OK 10 fresh GLBs, packed master, 120 actual inspection renders')
