...
if (-not $artOutput.StartsWith((Join-Path $d2Worker 'build/art07/d2')+[IO.Path]::DirectorySeparatorChar)) { throw 'Output must remain in the D2 build tree.' }
...
project(art07_d2_native LANGUAGES CXX)
...
Write-Output 'D2_NATIVE_BUILD_OK'
