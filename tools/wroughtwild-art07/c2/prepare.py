...
for n in ['kit.json','review.gd','scar.gdshader','wind.gdshader']:shutil.copy2(recipe/n,out/n)
for n in ['models.json','fossils.json','context.json']:shutil.copy2(kit/n,out/n)
for png in (out/'textures').glob('*.png'):
...
[application]
config/name="ART-07C2 Glasswind and Shellcut"
