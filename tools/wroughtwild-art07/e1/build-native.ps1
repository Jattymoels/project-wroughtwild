...
if (-not $artOutput.StartsWith((Join-Path $e1Worker 'build/art07/e1')+[IO.Path]::DirectorySeparatorChar)) { throw 'Output must remain in the E1 build tree.' }
...
project(art07_e1_native LANGUAGES CXX)
...
Write-Output 'E1_NATIVE_BUILD_OK'
