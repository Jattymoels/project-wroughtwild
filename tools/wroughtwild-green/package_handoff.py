"""Pack one checked Green review. Usage: REVIEW EDITABLE ASSETS SOURCE FRESH_OUT.
...
docs=repo/'docs/art/leyline-studies/2026-09-09/workshop-green'
shutil.copy2(docs/'green-root-input-v01.png',out/'provenance/green-root-input-v01.png')
...
print('GREEN_PACKAGE_VERIFIED',len(manifest),'files',sum(v['bytes'] for v in manifest.values()),'bytes')
