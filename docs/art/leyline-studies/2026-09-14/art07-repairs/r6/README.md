...
| --- | --- | ---: | --- |
| forward_plus | True | 13627 | `550b2d742314136a71a8c177920059bd245996e744b8722c8ba8c68afbde4a70` |
| gl_compatibility | True | 13627 | `550b2d742314136a71a8c177920059bd245996e744b8722c8ba8c68afbde4a70` |

The comparison includes every saved field, including native simulation, paid blocks/stations, resource records, leylines, contraptions and player/terrain state. It is separate from the small surface inspection fixture.
...
| --- | --- | --- | --- | --- |
| forward_plus / iron_vein | 0.439 / 0.816 / 2.045 | 0.448 / 0.801 / 2.054 | 78 → 78 | 101,858,304 → 132,450,304 |
| forward_plus / copper_vein | 0.453 / 0.820 / 1.824 | 0.455 / 0.779 / 1.619 | 100 → 100 | 101,858,304 → 132,450,304 |
| forward_plus / tin_vein | 0.461 / 0.774 / 1.475 | 0.461 / 0.828 / 1.638 | 108 → 108 | 101,858,304 → 132,450,304 |
| forward_plus / ember_iron_vein | 0.434 / 0.816 / 8.587 | 0.439 / 0.797 / 1.566 | 121 → 121 | 101,858,304 → 132,450,304 |
| forward_plus / silver_vein | 0.458 / 0.832 / 1.536 | 0.459 / 0.803 / 1.786 | 92 → 92 | 101,858,304 → 132,450,304 |
| gl_compatibility / iron_vein | 0.705 / 1.153 / 2.341 | 0.709 / 1.110 / 2.772 | 78 → 78 | 36,910,455 → 61,377,222 |
| gl_compatibility / copper_vein | 0.652 / 1.182 / 1.787 | 0.658 / 1.093 / 2.016 | 100 → 100 | 36,910,455 → 61,377,222 |
| gl_compatibility / tin_vein | 0.654 / 1.142 / 1.804 | 0.650 / 1.133 / 1.980 | 108 → 108 | 36,910,455 → 61,377,222 |
| gl_compatibility / ember_iron_vein | 0.726 / 1.227 / 2.297 | 0.703 / 1.122 / 2.203 | 121 → 121 | 36,910,455 → 61,377,222 |
| gl_compatibility / silver_vein | 0.710 / 1.164 / 1.743 | 0.699 / 1.119 / 2.264 | 92 → 92 | 36,910,455 → 61,377,222 |

The surface adds one shared 512 × 1280 RGBA field atlas (2,621,440 uncompressed bytes), one material per visible ore and no mesh/collider or draw surface. Texture totals also include the shared original C5 albedo/ORM loaded by this material. Current-machine results do not establish minimum-hardware acceptance or a population-wide loading budget; R2/R8 handle combined loading/integration.
...
| --- | --- | --- |
| `grain_repeats_m` | 1.7 | Reuse the C5 shared stone maps at their existing world-scale grain. |
| `normal_detail_m` | 0.006 | Fine shading relief only; no vertex displacement, depth offset or new solid volume. |
| `stock_transition_m` | 0.025 | Soften the boundary between remaining mineral and worked host over 2.5 cm; position uses current native units / full definition units. |
| `spent_tint` | 0.6 | Darken worked host while removing its mineral; keeps the entire unchanged picking ribbon visually present. |
| `pulse_period_s` | 3.5 | Retain C5's pause-aware native-heat pulse period; cold ore never emits except native hover feedback. |

Additional shader-resource finish values and atlas clamps are enumerated in [the tools README](../../../../../../tools/wroughtwild-art07-repairs/r6/README.md). Native dimensions, source colours, roughness, metallic response, units and heat/work rules remain inherited. No gameplay tuning is introduced.
