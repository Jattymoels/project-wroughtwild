...
![Editable source, recovered resin and junction](editable-preview.png)

![Native scarred root source in shade](source-shade.png)

![One request divides through the crafted resin](junction-passage.png)

![Actual held request, two independently paid receivers and one firing](green-junction.webp)
