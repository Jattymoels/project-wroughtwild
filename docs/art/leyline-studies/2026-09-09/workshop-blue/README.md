...
![Editable source, recovered flakes and delay](editable-preview.png)

![Native Blue source in shade](source-shade.png)

![Actual held request](delay-held.png)

![One three-second request and paid delivery](blue-delay.webp)
