...
Normal fresh prototype worlds now use `frontier_v9`, a finite 1,024 × 1,024 metre
...
this slice.
LAND-02 adds White/Impulse-displaced Scarwater Basin, recovered Gallery Woodland,
a real dry fissure, existing finite smithy work and two bank approaches connecting
the lake outlook and sheltered grove. It retains the four existing home cores.
V1–V8 and Living Frontier saves retain their own profile, geography and ownership;
