...
LAND-05 closeout implementation, 17 September 2026: the selected brief produces
fresh V13 with 50% ambient-herd retention after unchanged V12 composition, and
runtime cover/host-presentation refinements. The separate finite White stag,
...
rolling relief, four home opportunities, a quiet starter heartland and the
streaming work needed to validate that size. V6 defers its first eligible home
siege to night three; existing profiles retain their pacing and geography.
New games choose random seeds with a reproducible chosen-seed option. V5 inputs
are frozen before changing the generator. Two-kilometre worlds, infinite
generation and a broad graphics overhaul remain outside this bounded expansion.
...
a transformed result can itself be transformed by later Kind influence. The
reference is Smoulder developing into pulsing fire/cold Steam Plume. The owner
...
| D-032 | Finite world scale and opening | The [Wide Frontier intensive](../prototype/wide-frontier-intensive-2026-09-06.md) adds a 1,024 m V6 successor with larger rolling biomes, four home clearings, buffered starter supplies, first eligible home siege on night three, random or chosen fresh seeds, and bounded nearby terrain retention. V1–V5 retain identity and geography. Two kilometres, infinite generation, a general graphics overhaul and new content systems remain outside scope. | Accepted and implemented; 64-seed/historical checks and matched runtime review recorded, including remaining preparation cost (owner: “Okay let's do it”, 6 Sep 2026) | Owner exploration/building playtest and measured lower-spec performance |
