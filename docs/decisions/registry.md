...
- **D-023 (3 Sep 2026, the plate as a working):** the owner, on the
  ...
  **Slice 2 landed 4 Sep 2026** on the owner's rule that every ingot reads
  ...
  an enemy carrying the skill's status); mobs may be immune to a packet
  type and the engine deals packet by packet (the Hollow Knight and the
  Cinder Wisp take no fire, the knight's purpose having said so already).
