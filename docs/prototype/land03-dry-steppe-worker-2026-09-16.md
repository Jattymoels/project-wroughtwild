...
Introduce the **next unpublished successor, expected `frontier_v11`**, with separate frozen generation inputs/composition and select it for ordinary random/chosen-seed New World. Preserve V1–V10 and LF Continue without migration, reseeding or ownership changes. Do not edit published Scarwater geography to insert the new country. Preserve its completed art/terrain composition in the successor while adding the contrasting habitat; existing lake behavior, caves/digging, opening protections, four radius-14 m homes, discovery regions and rare families remain.
...
The plan deliberately adopts the current complete four-source ledger because restore expects all declared sources and devices share acquisition support. This is a scoped move into ordinary fresh LAND-03 successor worlds, independently of the LF campaign. **Keep ordinary `legacy` campaign policy.** Do not enable `living_frontier_wave4`, laboratories, Conservator progression, era transformations or unrelated LF campaign content to make devices available.
