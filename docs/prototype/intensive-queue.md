...
720p/1080p comparisons and bounded live-work timing. The next candidate is a
bounded INT-07B pass on the already recorded V6 generation and terrain-preparation
costs, keeping the same world geography and saved identity. Its implementation
plan should follow measurement; a larger world or new generation profile is not
implied.
