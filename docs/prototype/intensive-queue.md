...
| INT-05 | Dungeon presentation, traversal and pressure | Existing Forge rooms, routes and threats are readable, traversable and able to create pressure. | **INT-05A/B implemented, review pending:** [read the Forge](forge-readability-2026-09-07.md), then [contact and mixed reinforcements](forge-pressure-2026-09-08.md). Physical traversal, cover, native ownership, old boundaries and matched timing pass; live combat exposes substantially greater pressure. INT-05C is next. | Do routes, tells and encounter pressure work during ordinary play, including under Foundry effects? |
