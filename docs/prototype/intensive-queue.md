...
**Next: [LAND-00 high-effort creative discovery/research](land00-creative-discovery-prompt-2026-09-16.md).**
The owner explicitly inserted this before the slices. Compare creative directions,
research relevant precedents and recommend distinctive player experiences and a
revised landscape/biome/influence roadmap. The owner starts
`D:/Wroughtwild/work/land00-creative-discovery`, branch `codex/land00-creative-discovery`.
No implementation or automatic task launch. The previous six-slice outline is provisional.

**Prepared for later: [LAND-01 landscape/biome/influence plan](land01-landscape-plan-worker-2026-09-16.md).**
...
Update its brief from the selected LAND-00 direction before starting it.
