...
performance evidence. The next queued slice is INT-05: a bounded Forge dungeon
presentation/traversal audit and brief, followed by its selected readability
fixes. Combat-number calibration remains separate. Owner playtesting remains
