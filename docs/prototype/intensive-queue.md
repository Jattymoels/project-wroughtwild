...
| INT-04 | Sound, animation and interaction feedback | Existing gathering, footsteps, stations and surroundings gain consistent material and state feedback. | **INT-04A implemented, review pending:** [hear the work, recognise the result](interaction-feedback-2026-09-07.md). Local material work/release/collection and manual station completion now have truthful bounded feedback. Next: INT-04B grounded footsteps and nearby ambience brief, using the established local pipeline. | Do feedback and ambience feel convincing through repeated use? |
...
INT-04A's gathering/station feedback now has action, save, listening-reel and
matched performance evidence. The next proposed slice is INT-04B: grounded
footsteps and nearby ambience, with existing materials/places and no new enemy
hearing rules or external assets. Owner playtesting remains deferred while
