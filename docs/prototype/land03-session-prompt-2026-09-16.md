...
Work in `D:/Wroughtwild/work/land03-dry-steppe`, branch `codex/land03-dry-steppe`.

Read current `C:/Users/Matty/Dev/project-wroughtwild/AGENTS.md` and its required
reading order. Then read `build/land03/SETUP.md` and the complete authoritative
`docs/prototype/land03-dry-steppe-worker-2026-09-16.md`.
...
before final dressing. Deliver a structurally distinct living Dry Steppe with
low connected vegetation, irregular mineral ribs, shallow cuts, meaningful routes
and appealing home ground. Red Excitation should visibly affect eligible hosts,
...
appearance/play results, limitations, checks, matching DLL/source-art paths and
commit SHA. My coordinator handles main integration/push. Do not launch another
worker or implement LAND-04. Stop after LAND-03.
