...
The [Wave 7 contract and evidence](living-frontier-wave7-2026-09-09.md) records
...
```mermaid
flowchart TD
    A[Meteorite impacts] --> B[Different influences in the leyline network]
    B --> C[Altered land and ordinary animal hosts]
    ...
    I --> J[Laboratory Trials around the world]
    H --> J
    J --> K[First-clear failsafe resonance]
    K --> L[Next era transforms the same world]
    L --> C
    L --> D
    J --> M[Final confrontation with the survivor]
    M --> N[Captured controls and optional higher Heat]
    N --> J
```
