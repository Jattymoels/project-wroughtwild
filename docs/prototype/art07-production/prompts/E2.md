...
```text
Implement ART-07E2 only: Basic and improved forge.
...
OUTCOME
Deliver the basic forge and its upgraded appearance sharing one plinth/body. Fit the supported cowl, hot chamber and working plate inside existing dimensions; keep existing work and heat feedback.

ASSIGNED CATALOGUE OWNERSHIP
- devices: forge_basic, forge_improved
...
Use an isolated worktree/branch codex/art07-e2; reuse an existing correct app worktree.
Do not switch or edit the owner's shared checkout beneath another session.
Own tools/wroughtwild-art07/e2/ and docs/art/leyline-studies/2026-09-09/art07/e2/ only,
plus docs/prototype/art07-production/receipts/e2.md. Put generated work in fresh build/art07/e2/ versions.
...
REQUIRED CHECKS
- In-place upgrade and later kit preview show correct existing global tier, with no extra kit.
- Physical placement/corner fit, real forging and feeder attachment envelopes.
- Cold/work/paused feedback, ownership and separate-process reload; no new recipe or fuel cost.
...
FINISH
Write docs/prototype/art07-production/receipts/e2.md using receipts/TEMPLATE.md.
