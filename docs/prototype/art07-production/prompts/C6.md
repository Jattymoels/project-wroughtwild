...
```text
Implement ART-07C6 only: Ruins and workshop approaches.
...
- docs/prototype/exploration-storytelling-2026-09-07.md
...
OUTCOME
Produce surface/contact variants for existing ruin walls, thresholds, the old smithy and published LF approach marks. Pair worn masonry, roots and ground transitions without moving or sealing routes.

ASSIGNED CATALOGUE OWNERSHIP
- nature_support: ruin_wall, ruin_threshold, workshop_approach, trail_transition
...
Use an isolated worktree/branch codex/art07-c6; reuse an existing correct app worktree.
Do not switch or edit the owner's shared checkout beneath another session.
Own tools/wroughtwild-art07/c6/ and docs/art/leyline-studies/2026-09-09/art07/c6/ only,
plus docs/prototype/art07-production/receipts/c6.md. Put generated work in fresh build/art07/c6/ versions.
...
REQUIRED CHECKS
- Existing entrances, collision envelopes and source/route anchors remain unchanged.
- Old accidental-impact craft and deliberate later containment remain distinguishable.
- Actual before/after existing-scene views and a supported walking check; no new loot or recipes.
...
FINISH
Write docs/prototype/art07-production/receipts/c6.md using receipts/TEMPLATE.md.
