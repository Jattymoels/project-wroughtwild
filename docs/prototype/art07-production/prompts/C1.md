# ART-07C1 — Lantern Fen and Rustwater resources

Copy the complete prompt below into one implementation session.

```text
Implement ART-07C1 only: Lantern Fen and Rustwater resources.
...
OUTCOME
Build leaning bog oak, finite clay bank and harvestable reeds with short decorative sedge and non-glowing fungal/wood detail. Compose a small wet-margin review without altering water, geography or stock.

ASSIGNED CATALOGUE OWNERSHIP
- resource_nodes: bog_oak, clay_bank, reed_bed
- nature_support: fen_sedge, fungal_detritus
...
Use an isolated worktree/branch codex/art07-c1; reuse an existing correct app worktree.
Do not switch or edit the owner's shared checkout beneath another session.
Own tools/wroughtwild-art07/c1/ and docs/art/leyline-studies/2026-09-09/art07/c1/ only,
plus docs/prototype/art07-production/receipts/c1.md. Put generated work in fresh build/art07/c1/ versions.
...
REQUIRED CHECKS
- Bog oak, clay and reeds expose their own real work/aftermath states.
- Decorative sedge/mushrooms cannot be mistaken for an added renewable harvest.
- Wet ground contacts, daylight/shade, native work snapshot/reload and packed sources.
...
FINISH
Write docs/prototype/art07-production/receipts/c1.md using receipts/TEMPLATE.md.
