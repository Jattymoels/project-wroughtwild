...
```text
Implement ART-07D4 only: Timber, reed and cork materials.
...
OUTCOME
Author seven shared material families using the approved building sheet: five distinct timbers, woven reed and porous cork. Deliver reusable surfaces/atlas or tiling sources, mapping guidance and material swatches.

ASSIGNED CATALOGUE OWNERSHIP
- materials: wood, pine, bog_oak, ash_wood, resinheart, woven_reed, corkbark
...
Use an isolated worktree/branch codex/art07-d4; reuse an existing correct app worktree.
Do not switch or edit the owner's shared checkout beneath another session.
Own tools/wroughtwild-art07/d4/ and docs/art/leyline-studies/2026-09-09/art07/d4/ only,
plus docs/prototype/art07-production/receipts/d4.md. Put generated work in fresh build/art07/d4/ versions.
...
REQUIRED CHECKS
- Grain/end-grain/weave direction and scale at coarse/fine dimensions, neutral lighting and tiled seams.
- No baked illumination, added glow, visible background contamination or new legal forms.
- Exported texture colour spaces/sizes and both-renderer material review; compare against collected source concept.
...
SLICE-SPECIFIC NOTE
Can run alongside geometry sessions; use existing proxy shapes and publish stable texture names/mapping in its own manifest.

FINISH
Write docs/prototype/art07-production/receipts/d4.md using receipts/TEMPLATE.md.
