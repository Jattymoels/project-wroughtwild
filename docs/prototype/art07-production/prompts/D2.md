...
```text
Implement ART-07D2 only: Roofs, door and metal spans.
...
OUTCOME
Direct-model seven existing roof/joinery/span forms around D1 join boundaries: three covering roofs, hinged door, full masonry wedge, metal girder and malleable arch.

ASSIGNED CATALOGUE OWNERSHIP
- shapes: codex_roof_slope, codex_roof_hip, codex_roof_valley, door, roof_wedge, girder, arch
...
Use an isolated worktree/branch codex/art07-d2; reuse an existing correct app worktree.
Do not switch or edit the owner's shared checkout beneath another session.
Own tools/wroughtwild-art07/d2/ and docs/art/leyline-studies/2026-09-09/art07/d2/ only,
plus docs/prototype/art07-production/receipts/d2.md. Put generated work in fresh build/art07/d2/ versions.
...
REQUIRED CHECKS
- All legal turns, slope/hip/valley seams, door hinge directions/open-state and ceiling/corner contacts.
- Existing half-height covering roofs vs full-height masonry wedge remain distinct.
- No stone arch/door eligibility extension, new support system or changed world unlock.
...
FINISH
Write docs/prototype/art07-production/receipts/d2.md using receipts/TEMPLATE.md.
