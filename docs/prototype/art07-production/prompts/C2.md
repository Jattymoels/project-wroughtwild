...
```text
Implement ART-07C2 only: Glasswind and Shellcut quarry.
...
OUTCOME
Deliver layered slate, irregular fossil shellstone and low wind-worn tussocks, using B1 pine/B3 shelves for context. Source faces and worked material should visibly belong to the same family.

ASSIGNED CATALOGUE OWNERSHIP
- resource_nodes: slate_outcrop, shellstone_outcrop
- nature_support: upland_tussock
...
Use an isolated worktree/branch codex/art07-c2; reuse an existing correct app worktree.
Do not switch or edit the owner's shared checkout beneath another session.
Own tools/wroughtwild-art07/c2/ and docs/art/leyline-studies/2026-09-09/art07/c2/ only,
plus docs/prototype/art07-production/receipts/c2.md. Put generated work in fresh build/art07/c2/ versions.
...
REQUIRED CHECKS
- Distinct full/part-worked/depleted quarry faces, exact native stock and restart.
- Fossils vary and do not repeat as tiled medallions; split slate has actual layered silhouette.
- Existing approaches and work-target envelopes retained; near/far review and cost report.
...
FINISH
Write docs/prototype/art07-production/receipts/c2.md using receipts/TEMPLATE.md.
