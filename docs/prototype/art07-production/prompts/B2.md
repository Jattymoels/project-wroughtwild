...
```text
Implement ART-07B2 only: Ground cover and forest floor.
...
OUTCOME
Deliver a reusable low-plant/ground-material kit: saplings/shrubs, fern/bracken, meadow grass, bramble/climber, moss/lichen and leaf/needle litter. Make clusters and transitions, not a blanket scatter rule.

ASSIGNED CATALOGUE OWNERSHIP
- nature_support: sapling_shrub, fern_bracken, meadow_grass, bramble_climber, moss_lichen, leaf_needle_litter
...
Use an isolated worktree/branch codex/art07-b2; reuse an existing correct app worktree.
Do not switch or edit the owner's shared checkout beneath another session.
Own tools/wroughtwild-art07/b2/ and docs/art/leyline-studies/2026-09-09/art07/b2/ only,
plus docs/prototype/art07-production/receipts/b2.md. Put generated work in fresh build/art07/b2/ versions.
...
REQUIRED CHECKS
- Close and walking-height views show plausible attachments and nonrepeating ground transitions.
- Tiled textures and coarse-to-detailed surfaces have no bright seams; record transparent overdraw.
- Quiet ordinary materials, packed source reopen and two-renderer detail comparisons.
...
FINISH
Write docs/prototype/art07-production/receipts/b2.md using receipts/TEMPLATE.md.
