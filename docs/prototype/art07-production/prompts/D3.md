# ART-07D3 — Fine pieces and complete wall coverings

Copy the complete prompt below into one implementation session.

```text
Implement ART-07D3 only: Fine pieces and complete wall coverings.
...
- docs/prototype/home-placement-persistence-2026-09-07.md

OUTCOME
Finish five fine shapes and the two framed covering/glazing forms. Match the original lattice at half scale, with integral frames and material-correct surfaces.

ASSIGNED CATALOGUE OWNERSHIP
- shapes: half_cube, half_wall, half_pillar, half_beam, half_slab, light_panel, glazed_window
...
Use an isolated worktree/branch codex/art07-d3; reuse an existing correct app worktree.
Do not switch or edit the owner's shared checkout beneath another session.
Own tools/wroughtwild-art07/d3/ and docs/art/leyline-studies/2026-09-09/art07/d3/ only,
plus docs/prototype/art07-production/receipts/d3.md. Put generated work in fresh build/art07/d3/ versions.
...
REQUIRED CHECKS
- 0.5 m registry placement and exact coarse/fine joins, including small pillars/rails/shelves.
- Fixed cinderglass window and light panel preserve shelter, projectile and movement blocking.
- All legal family pairings, frame completeness, two-sided readability and imported sizes.
...
FINISH
Write docs/prototype/art07-production/receipts/d3.md using receipts/TEMPLATE.md.
