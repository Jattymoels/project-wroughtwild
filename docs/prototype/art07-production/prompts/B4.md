...
```text
Implement ART-07B4 only: First composed walk, light and distance.
...
- tools/wroughtwild-roster/LIFELINES.md
- docs/prototype/world-route-art-2026-09-09.md
- docs/prototype/quiet-ambience-2026-09-08.md

OUTCOME
Compose one isolated small walk from B1–B3 and approved ART-02 context, demonstrating near/middle/far fullness, physical scar depth, water/foliage motion and readable lighting. Use existing audio direction with quiet gaps; no new sound pack is required.

ASSIGNED CATALOGUE OWNERSHIP
- nature_support: leyline_scar, water_surface, wind_motion, far_treeline, far_rock_haze, light_and_quiet
...
Use an isolated worktree/branch codex/art07-b4; reuse an existing correct app worktree.
Do not switch or edit the owner's shared checkout beneath another session.
Own tools/wroughtwild-art07/b4/ and docs/art/leyline-studies/2026-09-09/art07/b4/ only,
plus docs/prototype/art07-production/receipts/b4.md. Put generated work in fresh build/art07/b4/ versions.
...
REQUIRED CHECKS
- Matched day/shade/dusk, emission-off and actual pulse/wind captures in both renderers.
- Open walking space, grounded contacts, depth measurements and pause-aware motion.
- Separate uncontended benchmark, draw/primitive/texture costs and explicit candidate budgets; do not claim ordinary world integration.
...
SLICE-SPECIFIC NOTE
This is the first environment technical checkpoint; later slices reuse its measured conventions, not its entire dense composition.

FINISH
Write docs/prototype/art07-production/receipts/b4.md using receipts/TEMPLATE.md.
