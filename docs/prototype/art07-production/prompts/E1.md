...
```text
Implement ART-07E1 only: Workbench and mason's yard.
...
OUTCOME
Deliver two compact stations with distinct working surfaces, using D4/D5 materials and the approved station board. Keep clamps/tools inside the existing 0.96 × 2 × 0.96 m station body.

ASSIGNED CATALOGUE OWNERSHIP
- devices: workbench, mason_yard

PREREQUISITES
ART-07D1, ART-07D4, ART-07D5.
...
Use an isolated worktree/branch codex/art07-e1; reuse an existing correct app worktree.
Do not switch or edit the owner's shared checkout beneath another session.
Own tools/wroughtwild-art07/e1/ and docs/art/leyline-studies/2026-09-09/art07/e1/ only,
plus docs/prototype/art07-production/receipts/e1.md. Put generated work in fresh build/art07/e1/ versions.
...
REQUIRED CHECKS
- Actual kit preview and paid placement in real wall/floor corners, rotations and both grid scales.
- No genuine collision bypass; failed placement retains kit; success yields one usable native station.
- Craft feedback, interaction, native ownership and fresh-process restore with packed model evidence.
...
FINISH
Write docs/prototype/art07-production/receipts/e1.md using receipts/TEMPLATE.md.
