...
LF-1C adds White on home clearing 1's +8 m X margin, with the same 8 × 16
saved lots and capped ten-minute active formation; Red remains on home 0.
Version-1 experimental source saves migrate their Red state exactly and receive
the new White host once. Version 2 requires both complete ledgers. No ordinary
terrain, resource or pressure stock is regenerated by this migration.
