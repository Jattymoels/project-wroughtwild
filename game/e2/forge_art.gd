...
extends RefCounted
## Production forge presentation. Static maps shared across tiers and all instances.
static var meshes := {}
...
static func _material(role: String) -> Material:
	...
	material.albedo_texture = R2Resources.resource("res://e2/textures/"+stem[role]+"_albedo.png")
	material.normal_enabled = true
	material.normal_scale = float(look().normal_strength)
	material.normal_texture = R2Resources.resource("res://e2/textures/"+stem[role]+"_normal.png")
	material.roughness_texture = R2Resources.resource("res://e2/textures/"+stem[role]+"_orm.png")
