...
extends RefCounted
## Production mesh substitution. Does not change bodies or native ownership.
static var meshes := {}
static var surfaces := {}
static var settings := {}
...
static func surface(role: String) -> Material:
	...
	if role in ["Ash", "Ember"]:
		...
		m.albedo_texture = R2Resources.resource("res://e3/textures/"+role+"_albedo.png")
		m.normal_enabled = true
		m.normal_scale = float(look().normal_strength)
		m.normal_texture = R2Resources.resource("res://e3/textures/"+role+"_normal.png")
		m.roughness_texture = R2Resources.resource("res://e3/textures/"+role+"_orm.png")
