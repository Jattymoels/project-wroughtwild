...
func _run() -> void:
	...
	check(trace._interval.arrivals.size()==trace.MAX_ARRIVAL_EVENTS and trace._interval.arrival_events_dropped==12,"per-interval event bound and explicit overflow count")
