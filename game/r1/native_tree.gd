...
func _apply_visual()->void:
	...
	if _terrain()!=null and _terrain().world_profile() in ["frontier_v10","frontier_v11"] and _biome_id()=="gallery_woodland":return
...
func _leave_stump()->void:
	if _terrain()!=null and _terrain().world_profile() in ["frontier_v10","frontier_v11"] and _biome_id()=="gallery_woodland":
		super._leave_stump()
		return
