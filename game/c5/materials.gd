...
static func apply(model:Node3D,row:Dictionary)->Array[ShaderMaterial]:
	...
	for mesh in model.find_children("*","MeshInstance3D",true,false):
		for s in mesh.mesh.get_surface_count():
			var mat:=ShaderMaterial.new();mat.shader=R2Resources.resource("res://c5/ore.gdshader")
			mat.set_shader_parameter("albedo_map",R2Resources.resource("res://c5/textures/rock-albedo.png"));mat.set_shader_parameter("orm_map",R2Resources.resource("res://c5/textures/rock-orm.png"))
