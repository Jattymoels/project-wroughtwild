...
func setup(from_terrain: Terrain, seed_value: int) -> void:
	...
	load_rules()
	_indexed = terrain.world_profile() in ["frontier_v6","frontier_v7","frontier_v8","frontier_v9","frontier_v10","frontier_v11","frontier_v12","frontier_v13","living_frontier_wave1","living_frontier_wave3"]
